...
def staging_table():
    ...
    try:
        ...
        logger.error(f"An error occurred during the update of {schema} table: {e} in staging_table task")
        raise e
...
def core_table():
    ...
    try:
        ...
        logger.error(f"An error occurred during the update of {schema} table: {e} in core_table task")
        raise e
